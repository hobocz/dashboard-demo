<template>
  ...
  >
    <ul class="navbar-nav">
      <li class="nav-item">
        <sidenav-collapse nav-text="Players" :to="{ name: 'PlayerTable' }">
          <template #icon>
      ...
      <li class="nav-item">
        <sidenav-collapse nav-text="Pitching" :to="{ name: 'TopYoungPitchersChart' }">
          <template #icon>
            <icon name="tables" />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse nav-text="Batting (todo)..." :to="{ name: 'Billing' }">
          <template #icon>
            <icon name="billing" />
          </template>
        </sidenav-collapse>
      ...
      <li class="nav-item">
        <sidenav-collapse nav-text="Fielding (todo)..." :to="{ name: 'Virtual Reality' }">
          <template #icon>
